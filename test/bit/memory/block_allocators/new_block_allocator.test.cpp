...
//-----------------------------------------------------------------------------
// new_block_allocator<1024,power_of_two_growth>
//-----------------------------------------------------------------------------

TEST_CASE("new_block_allocator<block_size,power_of_two_growth>" "[resource management]")
{
  ...
  auto block_allocator = bit::memory::new_block_allocator<block_size,growth_multiplier>{multiplier};
...
TEST_CASE("cached_new_block_allocator<block_size,power_two_growth>" "[resource management]")
{
  using growth_multiplier = bit::memory::power_two_growth;
  static constexpr auto block_size  = 1024;
  static constexpr auto growths     = 3u;
  ...
  auto multiplier = growth_multiplier(growths);
  auto block_allocator = bit::memory::cached_new_block_allocator<block_size,growth_multiplier>{multiplier};
