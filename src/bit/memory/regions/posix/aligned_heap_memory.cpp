...
#include <bit/memory/utilities/pointer_utilities.hpp> // offset_align_forward
#include <bit/memory/utilities/unaligned_storage.hpp> // store_unaligned, load_unaligned
